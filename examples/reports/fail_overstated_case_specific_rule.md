...
- failure_reasons: CLAIM_OVERSTATED, HUMAN_REVIEW_REQUIRED

## 10. Decision Trace
- {"candidate_count": 1, "final_citation_count": 1, "step": "citation_validation"}
- {"claim_count": 1, "failure_reasons": ["CLAIM_OVERSTATED"], "semantic_safe_to_present": false, "step": "claim_support"}
- {"answer_present": false, "failure_reasons": ["CLAIM_OVERSTATED", "HUMAN_REVIEW_REQUIRED"], "final_action": "human_review_required", "safe_to_present": false, "step": "trust_gate"}

## 11. Answer Claims
- `claim-001` (case_specific_application): 此判決規則一律適用於所有押金契約。

## 12. Claim Support Review
- `claim-001`: SupportStatus.OVERSTATED ([case_specific_overgeneralized]) via `official-demo-law-184-seg-03`
...
- failure_reasons: CLAIM_OVERSTATED
