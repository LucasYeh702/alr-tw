...
## 4. Retrieved Sources
- `cache-demo-001` (verified_cache, reject)
...
- `cache-demo-001` (reject, unverifiable)
...
- failure_reasons: NO_FINAL_CITATION, REJECTED_CITATION, UNVERIFIABLE_CITATION

## 10. Decision Trace
- {"candidate_count": 1, "final_citation_count": 0, "step": "citation_validation"}
- {"answer_present": false, "failure_reasons": ["NO_FINAL_CITATION", "REJECTED_CITATION", "UNVERIFIABLE_CITATION"], "final_action": "refuse", "safe_to_present": false, "step": "trust_gate"}
