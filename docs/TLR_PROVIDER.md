...
ALR-TW v0.9.1 以 clean-room adapter（淨室轉接器）接入 [TLR（Taiwan Legal RAG）公開專案](https://github.com/aa0101181514/tw-legal-rag)的 HTTP API。實作只依公開 OpenAPI 行為撰寫；未複製 TLR 或其他參考專案的程式碼。
