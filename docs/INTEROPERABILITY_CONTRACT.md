...
本文件定義 v0.9.1 的前端無關接口。任何能呼叫 MCP tool 的法律
...
The v0.9.1 public surface also includes structural applicability resolution,
...
The v0.9.1 surface adds an optional semantic-verifier sidecar. It can
...
The v0.9.1 provider boundary also exposes a common conformance validator and an
...
This is the v0.9.1-compatible default. ALR-TW plans and executes its bounded
