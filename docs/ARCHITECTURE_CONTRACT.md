...
## v0.10.0 agent-neutral contract
...
The v0.10.0 contract adds an optional untrusted planning boundary and a
...
v0.10.0 server-owned records 混作同一 authority store。`ready_for_draft` 只代表
