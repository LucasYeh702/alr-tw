# ALR-TW v0.10.0 Acceptance

ALR-TW v0.10.0 可宣稱為「台灣法律 Agentic RAG / MCP research safety
...
v0.10.0 另加入 semantic verifier sidecar、provider conformance、
...
- CLI/MCP purge 同一實作；
- v0.10.0 contract、既有工具與 payload 的 additive compatibility、build 與 stdio smoke 應通過；
