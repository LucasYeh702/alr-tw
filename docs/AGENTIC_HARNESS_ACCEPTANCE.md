# ALR-TW v0.8.0 Acceptance

ALR-TW v0.8.0 可宣稱為「台灣法律 Agentic RAG / MCP research safety
...
- CLI/MCP purge 同一實作；
- v0.8.0 contract、既有工具與 payload 的 additive compatibility、build 與 stdio smoke 應通過；
