...
class ProviderErrorCode(str, Enum):
    ...
    TLR_RESULT_TOKEN_INVALID_OR_EXPIRED = "TLR_RESULT_TOKEN_INVALID_OR_EXPIRED"
    TLR_DOCUMENT_NOT_FOUND = "TLR_DOCUMENT_NOT_FOUND"
    ...
    LEGACY_JUDGMENT_IDENTIFIER_UNRESOLVED = "LEGACY_JUDGMENT_IDENTIFIER_UNRESOLVED"
    LEGACY_JUDGMENT_IDENTIFIER_AMBIGUOUS = "LEGACY_JUDGMENT_IDENTIFIER_AMBIGUOUS"
